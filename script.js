...
const translations = {
  en: {
    ...
    "about.title": "a room you slowly build inside yourself",
    "about.copy": "Room is not just a place. It stores old photos, half-written diaries, the mug on your desk, and a future room you have not moved into yet.",
    "about.copyTwo": "Kikuyu Room believes in curation, not owning more. We choose small pieces that deserve to stay and help ordinary days become memorable.",
  ...
  zh: {
    ...
    "about.title": "一个会随着时间，慢慢住进你心里的房间",
    "about.copy": "Room 不只是空间。它保存旧照片、写到一半的日记、桌上的马克杯，以及未来还没有住进去的房间。",
    "about.copyTwo": "Kikuyu Room 相信策展，而不是拥有越多越好。我们认真挑选值得留下的小物，让普通日子也变得值得纪念。",
